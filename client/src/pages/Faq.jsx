    ...
    <div className="faq-page">
        ...
        <div className="hero-container">
          ...
          >
            <h1 className="hero-title">
              Got Questions?{" "}
              <span className="brand-highlight">We’ve Got Answers</span>
            </h1>
            <p className="hero-subtitle">
              Explore frequently asked questions about StudyMatePlus, resources,
              and features.
            </p>
          </motion.div>
        </div>
      ...
      <section className="contact-section container">
        ...
        <p>
          ...
          <b>support@studymateplus.com</b> or fill out the form below.
        </p>
