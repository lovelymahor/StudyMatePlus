  ...
  return (
    <div className="todo-page">
      ...
      <div className="todo-card">
        <h2>To‑Do List</h2>
        <p className="muted">
          Use the calendar to pick a date or click Add New Task in the panel.
        </p>
          ...
          <div className="smp-modal-content">
            ...
            <form className="todo-form" onSubmit={handleSubmit}>
              ...
              <textarea
                ...
                placeholder="Add notes, requirements, or important details..."
              />
          ...
          {tasks.map((t) => (
            <li key={t.id} className={`task ${t.completed ? "done" : ""}`}>
              <div className="task-main">
                ...
                <div className="task-info">
                  ...
                  <div className="task-meta">
                    Due {new Date(t.deadline).toLocaleString()} •{" "}
                    {t.recurrence !== "none" ? `${t.recurrence}` : "one‑time"}
                  </div>
                  {t.description && (
              ...
              <div className="task-actions">
                {t.recurrence !== "none" && (
                  <button
                    title="Advance to next occurrence"
                    onClick={() => handleAdvanceOnce(t.id)}
                  >
                    ⤴
                  </button>
                )}
